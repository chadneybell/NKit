...
namespace Nanook.NKit
{
    ...
    {
        private readonly Queue<ScrubRegion> _scrub;
        private readonly List<ScrubRegion> _cache; //for debugging
        private ScrubRegion _next;
        private ScrubRegion _last;
        private readonly object _lock;

        private readonly bool _wiiPartition;
        private readonly ByteStream _00;
        private readonly ByteStream _FF;
        ...
        private void add(long offset, long length, byte b) //called on different thread to IsScrubbed
        {
            ...
            offset = offset / 0x7c00L * 0x8000L;
            length = length / 0x7c00L * 0x8000L;
