...
namespace Nanook.NKit
{
    internal class WiiDiscHeaderSection : MemorySection, IWiiDiscSection
    {
        ...
        private readonly List<WiiPartitionInfo> _partitions;
        ...
        public int Version => Data[7];

        public int DiscNo => Data[6];

        public string Title { get; private set; }
        public bool HasUpdatePartition { get; private set; }
        public WiiPartitionInfo[] Partitions => _partitions.ToArray();
        ...
        public static long PartitionTableOffset => _PartitionTableOffset;
        public static long PartitionTableLength => _PartitionTableLength;
        ...
        internal WiiDiscHeaderSection(MemorySection header) : base(header.Data)
        {
            ...
            Title = ReadStringToNull(0x20, 0x60);

            _partitions = CreatePartitionInfos(header, _PartitionTableOffset).ToList();
            HasUpdatePartition = _partitions[0].Type == PartitionType.Update;
        }
        ...
        internal void RemoveUpdatePartition(long baseAddress)
        {
            ...
            Array.Clear(Data, _PartitionTableOffset, _PartitionTableLength);

            //write the partition info
            MemorySection hdrStream = new MemorySection(Data);
