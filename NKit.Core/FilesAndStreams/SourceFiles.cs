...
namespace Nanook.NKit
{
    ...
    public static class SourceFiles
    {
        ...
        {
            return RemoveExtension(filename, filenameOnly, out string ext);
        }

        public static string ChangeExtension(string filename, bool filenameOnly, string newExtension)
        {
            return string.Format("{0}.{1}", RemoveExtension(filename, filenameOnly, out string ext), newExtension.TrimStart('.'));
        }
